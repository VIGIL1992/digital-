...
<div class="login-box">
	...
	<br>
	<p class="pc-login"><b>Try to log in from a PC for the better user interface</b></p>
</div>

<p class="copyright">
	<b>
	Copyright <i class="fa fa-copyright" aria-hidden="true"></i> <script>document.write(new Date().getFullYear());</script> All rights reserved | 
    Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="http://www.pixellmedia.com/" target="_blank" style="color: #b052be;">PixellMedia</a>
	</b>
</p>
